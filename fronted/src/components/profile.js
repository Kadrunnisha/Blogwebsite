...
import { useNavigate } from "react-router-dom";
 ...
 const Profile=()=>{
   ...
   const updateemail = async () => {
    try {
      const response = await fetch('http://localhost:8001/api/email-update', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updatename = async () => {
    try {
      const response = await fetch('http://localhost:8001/api/name-update', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updatenumber = async () => {
    try {
      const response = await fetch('http://localhost:8001/api/number-update', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deleteaccount= async () => {
    try {
      const response = await fetch('http://localhost:8001/api/profile-delete', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
